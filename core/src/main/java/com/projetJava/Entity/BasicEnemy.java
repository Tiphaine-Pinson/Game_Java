...
public class BasicEnemy extends Enemy {
    ...
    public BasicEnemy(float health, float posX, float posY, float width, float height, int speed, World world,
            TextureAtlas idleAtlas, TextureAtlas walkAtlas, TextureAtlas attackAtlas, TextureAtlas deathAtlas) {
        super(health, posX, posY, width, height, speed, world, 6, 50);
    ...
    public void moveToRight() {
        body.setLinearVelocity(new Vector2(speed, body.getLinearVelocity().y + body.getWorld().getGravity().y));
    }
