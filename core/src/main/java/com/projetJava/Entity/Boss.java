...
public class Boss extends Enemy {
    ...
    public Boss(float health, float posX, float posY, float width, float height, int speed, World world,
            TextureAtlas idleAtlas, TextureAtlas walkAtlas, TextureAtlas attackAtlas, TextureAtlas deathAtlas) {
        super(health, posX, posY, width, height, speed, world, 100, 50, 30);
